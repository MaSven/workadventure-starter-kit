(() => {
  ...
  var defaultAssetsUrl = "https://unpkg.com/@workadventure/scripting-api-extra@1.1.1/dist";
    ...
    if (configurationLayer) {
      ...
      for (const layer of layersMap2.values()) {
        ...
        if (openConfigVariables && layer.type === "tilelayer") {
          initLocalConfigurationPanel(openConfigVariables, properties2);
        }
      }
    }
  }
